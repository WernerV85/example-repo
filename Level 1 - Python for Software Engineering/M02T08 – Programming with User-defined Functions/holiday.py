...
def plane_cost(city_flight_ref, flight_rates):
    for value in flight_rates.values():
        flight_cost = flight_rates[city_flight_ref]
        return (float(flight_cost[value]))
...
flight_rates = {"Johannesburg" : 2500,
               "Cape Town" : 4800,
               "Bloemfontein" : 1900,
               "KwaZulu Natal" : 3450}
